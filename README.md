...
## 📂 Download Data (Link Direct)
Pentru dezvoltatori și integratori (Google Maps, Apple Maps, Moovit), utilizați acest link permanent pentru preluarea automată a datelor:

> **🔗 [DESCARCĂ GTFS.zip (Direct Link)](./ungheni_gtfs.zip)**

*Note for developers: This link serves the latest production version of the feed.*
